...
const aiAgents = [
  {
    id: 'CEO',
    name: 'Direction',
    role: 'Conseil strategique',
    description: 'Coordonne les experts pour realiser vos projets digitaux.',
    color: 'gold',
    icon: Brain,
    status: 'active',
    capabilities: ['Conseil strategique', 'Planification', 'Coordination', 'Reporting'],
  },
  {
    id: 'Commercial',
    name: 'Commercial',
    role: 'Devis et projets',
